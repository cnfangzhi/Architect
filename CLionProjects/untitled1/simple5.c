...
void test(){
	...
	char* fileName = "D:\\temp\\Simple.txt";
...
void test2(){
	...
	char* fileName = "D:\\temp\\Simple_Write.txt";
...
// 文件复制，当做二进制文件来操作
void test3(){
	char* fileName = "D:\\temp\\image.jpg";
	char* fileCopyName = "D:\\temp\\image_copy.jpg";
...
void test5(){
	char* fileName = "D:\\temp\\image.jpg";
	char* fileEncrpyName = "D:\\temp\\image_en.jpg";
...
// 文件的解密
void test6(){
	char* fileEnName = "D:\\temp\\image_en.jpg";
	char* fileDeName = "D:\\temp\\image_de.jpg";
...
// 就改一个字节, 过不去
void test7(){
	char* fileEnName = "D:\\temp\\image.jpg";
	// rwb
...
void test9(){
	char* fileName = "D:\\temp\\image_en.jpg";
	char* fileDeName = "D:\\temp\\image_de.jpg";
...
void test10(){
    ...
    for (; i < 3; i++)
    {
        ...
        sprintf(file_names[i], "D:\\temp\\image_%d.jpg", i);
